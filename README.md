...
The difference is responsive websites adjust its layout accordingly, respond to the size of the browser at any given point. A responsive website shows content based on the available browser space.  responsive design relies on changing the design pattern to fit the real estate available to it.
...
A preprocessor is a program that takes one type of data and converts it to another type of data. there are many CSS preprocessors to choose from, however most CSS preprocessors will add some features that don't exist in pure CSS, such as mixin, nesting selector, inheritance selector, and so on. These features make the CSS structure more readable and easier to maintain.

5. What is your favorite concept in preprocessing? What is the concept that gives you the most trouble?

My favorite conccept is Escaping, which makes changing media quries easier. Function gives me the most trouble because there are too many out there and hard to remember.
